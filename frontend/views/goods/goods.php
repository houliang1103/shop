...
<!-- 头部 end -->
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="<?=\yii\helpers\Url::to('index')?>">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > ThinkPad X230(23063T4）12.5英寸笔记本</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php if($good->images){
						    echo $good->images[0]->path."?imageView2/1/w/800/h/800";
                        } ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php if($good->images){
                                echo $good->images[0]->path."?imageView2/1/w/350/h/350";
                            } ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php if($good->images){ foreach ($good->images as $k=>$v):?>
								<li class="<?=$k==0?'cur':''?>">
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li ><span>库存：</span> <strong></strong><a href=""><?=$good->stock?></a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to('cart')?>" method="get" class="choose">
						<ul>
