...
<head>
	...
	<link rel="stylesheet" href="/static/style/success.css" type="text/css">
...
<body>
	...
	<div class="success w990 bc mt15">
		...
		<div class="success_bd">
            ...
            <p>请用微信支付</p>
            <p><img src="<?=\yii\helpers\Url::to(['wepay','id'=>$id])?>" alt=""/></p>
			<p class="message">完成支付后，你可以 <a href="">查看订单状态</a>  <a href="<?=\yii\helpers\Url::to('/goods/index')?>">继续购物</a> <a href="javascript:;"></a></p>
		</div>
	</div>
	<!-- 主体部分 end -->
